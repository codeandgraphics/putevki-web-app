...
class Users extends Model
{
    ...
    public function afterFetch()
    {
        ...
        $this->messagesNotificationsEnabled =
            (int) $this->messagesNotificationsEnabled;
        $this->commentsNotificationsEnabled =
            (int) $this->commentsNotificationsEnabled;
    }
    ...
    public function format()
    {
        ...
        $user->messagesNotificationsEnabled =
            (int) $this->messagesNotificationsEnabled;
        $user->commentsNotificationsEnabled =
            (int) $this->commentsNotificationsEnabled;
