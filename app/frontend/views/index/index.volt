	...
	<section class="block mobile-promo" id="mobile-promo">
		<div class="container">
			<div class="promo-block">
				...
				<div class="text">
					<h3>Все путевки в твоем смартфоне!</h3>
					<p>Ищите самые выгодные цены на путевки в любом месте,<br/>где бы вы не находились!</p>
				</div>
		...
		<div class="content">
			<div class="container">
				...
				<p>
					...
					Tez Tour, TUI, Sunmar, а&nbsp;также крупнейшее в&nbsp;России объединение независимых агентств
				...
				<p>
					Бронирование и&nbsp;поиск лучших туров онлайн. Горящие путевки
					в&nbsp;<a href="{{ url('countries/turkey') }}" title="путевки в Турцию">Турцию</a>,
					<a href="{{ url('countries/thailand') }}" title="путевки в Таиланд">Таиланд</a>,
					<a href="{{ url('countries/dominican') }}" title="путевки в Доминикану">Доминикану</a>,
					<a href="{{ url('countries/uae') }}" title="путевки в ОАЭ">ОАЭ</a>
					и&nbsp;<a href="{{ url('') }}">другие направления</a>.
					Бронирование путёвок в&nbsp;режиме онлайн с&nbsp;оплатой путевки банковской картой.
					путевки от&nbsp;крупнейших туроператоров, 100% актуальность предложений, автоматическое
