<div class="pay-variants locked">
	...
	<div class="message no-online hide">
		<i class="ion-alert-circled"></i> Извините, данную путевку нельзя оплатить онлайн, но наши менеджеры свяжутся с вами и закажут её для вас!
	</div>
	...
	<div class="tab-content">
				...
				<div class="row checkout-block">
					...
					<div class="col-xs-7">
						<div class="button-wrap">
							...
							<p class="small">Нажимая "Купить путевку" Вы подтверждаете согласие на обработку персональных данных.</p>
						</div>
		...
		<div class="tab-pane" id="buy-request">
			<form method="POST" id="request-form" data-toggle="validator" action="{{ url('ajax/formRequest') }}">
				...
				<div class="message">
					<p>Заявка на путевку не является бронированием и не накладывает на Вас каких-либо обязательств.</p>
