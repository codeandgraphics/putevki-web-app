					...
					<div class="cell">
						{% if tour.countrycode == '47' %}
							<div class="first form-group">
								...
								<input type="text" class="form-control" id="tourist-lastname-{{ i }}" name="tourists[{{ i }}][lastname]" placeholder="по паспорту" required>
							</div>
						...
						{% else %}
							<div class="first form-group">
								<label for="tourist-lastname-{{ i }}" class="control-label">Фамилия</label>
								<input type="text" class="form-control" id="tourist-lastname-{{ i }}" name="tourists[{{ i }}][lastname]" placeholder="по загранпаспорту" data-inputmask-regex="[a-zA-Z]+" required>
							</div>
							<div class="second form-group">
								<label for="tourist-firstname-{{ i }}" class="control-label">Имя</label>
								<input type="text" class="form-control" id="tourist-firstname-{{ i }}" name="tourists[{{ i }}][firstname]" placeholder="по загранпаспорту" data-inputmask-regex="[a-zA-Z]+" required>
							</div>
						{% endif %}
					</div>
					<div class="cell">
						<div class="first form-group">
							...
							<label for="tourist-gender-female-{{ i }}" class="gender">
