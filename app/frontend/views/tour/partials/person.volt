	...
	<div class="row">
		<div class="col-xs-6">
			...
			<div class="confirm form-group">
				...
				<label for="confirmation-{{ type }}" class="control-label">Я согласен с условиями <a href="{{ url('agreement') }}" target="_blank">договора-оферты на туристическое обслуживание</a>.</label>
			</div>
			{% endif %}
		</div>
		<div class="col-xs-6">
